...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#10122a] flex flex-col items-center justify-center px-4 overflow-hidden relative">
      ...
      <div className="flex flex-col items-center text-center max-w-sm w-full relative z-10">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[#505070] text-xs font-black tracking-widest">OR</span>
            <div className="flex-1 border-t-2 border-[#2e3060]" />
          </div>
